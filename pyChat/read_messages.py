...
class ReadMessages(Thread):
    ...
    def __init__(self, host, queue, callback):
        ...
        self._url = 'amqp://guest:guest@{0}:5672/%2F'.format(host)
        self._callback = callback
        self.QUEUE = queue
        Thread.__init__(self, name="ReadMessages")
...
class read_messages(Thread):
    def __init__(self, queue, queue_name, host):
        __mqueue = queue
        self.queue_name = queue_name
        self.host = host
        Thread.__init__(self, name="read_messages")
